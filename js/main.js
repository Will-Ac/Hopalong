...
function applyRangesOverrideFromEditor() {
  ...
  appData.defaults.formulaSeeds[formulaId] = readSeedEditorDraft(formulaId);
  saveDefaultsToStorage();
  setRangesEditorWarning("Applied defaults.");
  requestDraw();
...
function populateSeedFormulaOptions() {
  // Seed editor follows the currently selected formula in ranges editor.
}
